...
class AccountController extends Controller
{
     ...
     *
     * @Route("/new", name="physicalaccount_new")
     * @Method({"GET", "POST"})
     */
    public function newPhysicalAccountAction(Request $request)
    {
        $account = new Account();
        $form = $this->createForm('AccountBundle\Form\PhysicalAccountType', $account);
     ...
     * Creates a new account entity.
     *
     * @Route("/moral/new", name="moralaccount_new")
     * @Method({"GET", "POST"})
     */
    public function newMoralAccountAction(Request $request)
    {
        $account = new Account();
        $form = $this->createForm('AccountBundle\Form\MoralAccountType', $account);
        $form->handleRequest($request);
        ...
        return $this->render('account/moral_account_new.html.twig', array(
            'account' => $account,
            'form' => $form->createView(),
        ));
    }
